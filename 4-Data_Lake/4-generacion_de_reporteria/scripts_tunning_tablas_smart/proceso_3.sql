...
INSERT OVERWRITE TABLE ${hiveconf:PARAM_USERNAME}_SMART.TRANSACCION_POR_TRABAJO
SELECT
    TRABAJO_PERSONA,
    COUNT(1),
...
SELECT * FROM ${hiveconf:PARAM_USERNAME}_SMART.TRANSACCION_POR_TRABAJO LIMIT 10;